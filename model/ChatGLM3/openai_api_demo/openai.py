...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained('../basic_demo/chatglm3-6b', trust_remote_code=True)
    model = AutoModel.from_pretrained('../basic_demo/chatglm3-6b', trust_remote_code=True).float()
    model = model.eval()
